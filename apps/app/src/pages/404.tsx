...
const PublicLayout = dynamic(import('@aei/app/src/app/(public)/layout'), { ssr: false }); // Async API cannot be server-side rendered
const RootLayout = dynamic(import('@aei/app/src/app/layout'), { ssr: false }); // Async API cannot be server-side rendered
