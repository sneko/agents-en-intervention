...
import agentsStatementContent from '@aei/app/src/app/(public)/(compliance)/terms-of-use/for-agents/content.transformed.html';
import othersStatementContent from '@aei/app/src/app/(public)/(compliance)/terms-of-use/for-others/content.transformed.html';
