...
import { CaseCompetentThirdPartyField } from '@aei/app/src/components/CaseCompetentThirdPartyField';
import { CaseDomainField } from '@aei/app/src/components/CaseDomainField';
import { CloseCaseCard } from '@aei/app/src/components/CloseCaseCard';
import { FileList } from '@aei/app/src/components/FileList';
import { NoteCard } from '@aei/app/src/components/NoteCard';
import { Messenger } from '@aei/app/src/components/messenger/Messenger';
import { Uploader } from '@aei/app/src/components/uploader/Uploader';
import { UpdateCaseSchema, UpdateCaseSchemaType, updateCaseAttachmentsMax } from '@aei/app/src/models/actions/case';
import { AttachmentKindSchema, UiAttachmentSchemaType } from '@aei/app/src/models/entities/attachment';
import { CaseAttachmentTypeSchema, CasePlatformSchema, CaseStatusSchema, CaseStatusSchemaType } from '@aei/app/src/models/entities/case';
import { CitizenGenderIdentitySchema, CitizenGenderIdentitySchemaType } from '@aei/app/src/models/entities/citizen';
import { PhoneInputSchemaType, PhoneTypeSchema, PhoneTypeSchemaType } from '@aei/app/src/models/entities/phone';
import { notFound } from '@aei/app/src/proxies/next/navigation';
import { attachmentKindList } from '@aei/app/src/utils/attachment';
import { isReminderSoon } from '@aei/app/src/utils/business/reminder';
import { unprocessedMessagesBadgeAttributes } from '@aei/app/src/utils/dsfr';
import { centeredAlertContainerGridProps, centeredContainerGridProps, ulComponentResetStyles } from '@aei/app/src/utils/grid';
import { CaseStatusChip } from '@aei/ui/src/CaseStatusChip';
import { ErrorAlert } from '@aei/ui/src/ErrorAlert';
import { LoadingArea } from '@aei/ui/src/LoadingArea';
import { PhoneField, getDefaultPhoneValue } from '@aei/ui/src/PhoneField';
