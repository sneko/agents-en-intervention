...
import '@aei/app/src/components/uploader/drag-drop.scss';
import { AttachmentKindRequirementsSchemaType, UiAttachmentSchema, UiAttachmentSchemaType } from '@aei/app/src/models/entities/attachment';
import { mockBaseUrl, shouldTargetMock } from '@aei/app/src/server/mock/environment';
import { getExtensionsFromFileKinds, getFileIdFromUrl, getFileKindFromMime, getMimesFromFileKinds } from '@aei/app/src/utils/attachment';
