...
import { imageB64Data } from '@aei/app/src/fixtures/image';
import { parseApiWebhookPayload } from '@aei/app/src/fixtures/mailjet/mailjet';
import {
...
} from '@aei/app/src/utils/mailjet-mappers';
...
describe('decodeParseApiWebhookPayload()', () => {
  ...
  it('should return values with real saved payload', async () => {
    ...
    expect(decodedPayload).toStrictEqual({
      ...
      to: [
        {
          email: 'dossier-61@aei.incubateur.net',
