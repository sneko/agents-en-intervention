...
import { EditorStateSchemaType } from '@aei/app/src/models/entities/lexical';
import { ContactInputSchema, ContactInputSchemaType } from '@aei/app/src/models/entities/messenger';
import { quotedReplyMarkerClass } from '@aei/ui/src/emails/layouts/standard';
import { inlineEditorStateFromHtml } from '@aei/ui/src/utils/lexical';
...
export async function decodeParseApiWebhookPayload(jsonPayload: object): Promise<ReceivedMessage> {
  ...
  // with one being the real content and others that are just empty HTML as you can see in `apps/app/src/fixtures/mailjet/mailjet-real-payload-multiple-html-parts.json`
